...
/**
 * JUnit tests for european marble solitaire model class.
 */
public class EuropeanSolitaireModelTest {
  ...
  @Before
  public void setup() {
    this.e0 = new EuropeanSolitaireModel();
    this.e1 = new EuropeanSolitaireModel(5);
    this.e2 = new EuropeanSolitaireModel(0, 3);
    this.e3 = new EuropeanSolitaireModel(7, 8, 9);
  }
  ...
  public void constructorExceptions1() {
    for (int thickness : new int[]{6, 1, -5}) {
      try {
        new EuropeanSolitaireModel(thickness);
        fail(String.format(
                "Error should have been thrown: EuropeanSolitaireModel(%d)",
                thickness));
        return;
  ...
  public void constructorExceptions2() {
    for (int[] pos : new int[][]{
        new int[]{0, 0}, new int[]{10, 100}, new int[]{8, 4}, new int[]{-8, 4}
    }) {
      try {
        new EuropeanSolitaireModel(pos[0], pos[1]);
        fail(String.format(
                "Error should have been thrown: EuropeanSolitaireModel(%d, %d)",
                pos[0], pos[1]));
        return;
      } catch (IllegalArgumentException e) {
        //error was properly thrown and caught
  ...
  public void constructorExceptions3() {
    for (int[] params : new int[][]{
      ...
      try {
        new EuropeanSolitaireModel(params[0], params[1], params[2]);
        fail(String.format(
                "Error should have been thrown: EuropeanSolitaireModel(%d, %d, %d)",
  ...
  public void getSlotAt() {
    ...
    assertEquals(MarbleSolitaireModelState.SlotState.Invalid, this.e0.getSlotAt(0, 0));
    assertEquals(MarbleSolitaireModelState.SlotState.Invalid, this.e1.getSlotAt(2, 11));
    assertEquals(MarbleSolitaireModelState.SlotState.Invalid, this.e2.getSlotAt(6, 1));
    assertEquals(MarbleSolitaireModelState.SlotState.Invalid, this.e3.getSlotAt(17, 17));
  }
  ...
  public void getScore() {
    assertEquals(36, this.e0.getScore());
    assertEquals(128, this.e1.getScore());
    assertEquals(36, this.e2.getScore());
    assertEquals(276, this.e3.getScore());

    this.playGame();

    assertEquals(5, this.e0.getScore());
  }
}