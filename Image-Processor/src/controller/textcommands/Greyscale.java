...
/**
 * Class represents the greyscale command.
 */
public class Greyscale extends NameDestCommand {
  /**
   ...
   */
  public Greyscale(String name, String dest) {
    super(name, dest);
  }
  ...
  public void execute(ImageProcessingModel m, ImageProcessingTextView v)
    ...
    m.greyscale(this.name, this.dest);
    v.renderMessage(
            String.format("%s was saved as a greyscale image called %s",
                    this.name, this.dest));
