...
/**
 * Class represents the vertical flip command.
 */
public class VerticalFlip extends NameDestCommand {
   ...
   */
  public VerticalFlip(String name, String dest) {
    super(name, dest);
  }
  ...
  public void execute(ImageProcessingModel m, ImageProcessingTextView v)
    ...
    m.verticalFlip(name, dest);
    v.renderMessage(
            String.format("%s was saved as a vertically flipped image called %s",
                    name, dest));
  }
}
