...
/**
 * Class represents the value component greyscale command.
 */
public class ValueComp extends NameDestCommand {
   ...
   */
  public ValueComp(String name, String dest) {
    super(name, dest);
  }
  ...
  public void execute(ImageProcessingModel m, ImageProcessingTextView v)
    ...
    m.valueComponent(name, dest);
    v.renderMessage(
            String.format("%s was saved as a value component greyscale image called %s",
                    name, dest));
  }
}
