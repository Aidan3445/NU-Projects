...
/**
 * Class represents the luma component greyscale command.
 */
public class LumaComp extends NameDestCommand {
   ...
   */
  public LumaComp(String name, String dest) {
    super(name, dest);
  }
  ...
  public void execute(ImageProcessingModel m, ImageProcessingTextView v)
    ...
    m.lumaComponent(name, dest);
    v.renderMessage(
            String.format("%s was saved as a luma component greyscale image called %s",
                    name, dest));
  }
}
