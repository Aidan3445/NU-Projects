...
/**
 * Class represents a sepia command.
 */
public class Sepia extends NameDestCommand {
  /**
   ...
   */
  public Sepia(String name, String dest) {
    super(name, dest);
  }
  ...
  public void execute(ImageProcessingModel m, ImageProcessingTextView v)
    ...
    m.sepia(this.name, this.dest);
    v.renderMessage(
            String.format("%s was saved as a sepia-toned image called %s",
                    this.name, this.dest));
