...
/**
 * Class represents the red component greyscale command.
 */
public class RedComp extends NameDestCommand {
  /**
   ...
   */
  public RedComp(String name, String dest) {
    super(name, dest);
  }
  ...
  public void execute(ImageProcessingModel m, ImageProcessingTextView v)
    ...
    m.redComponent(this.name, this.dest);
    v.renderMessage(
            String.format("%s was saved as a red component greyscale image called %s",
                    this.name, this.dest));
  }
}
