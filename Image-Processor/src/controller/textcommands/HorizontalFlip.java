...
/**
 * Class represents the horizontal flip command.
 */
public class HorizontalFlip extends NameDestCommand {
  /**
   ...
   */
  public HorizontalFlip(String name, String dest) {
    super(name, dest);
  }
  ...
  public void execute(ImageProcessingModel m, ImageProcessingTextView v)
    ...
    m.horizontalFlip(name, dest);
    v.renderMessage(
            String.format("%s was saved as a horizontally flipped image called %s",
                    name, dest));
  }
}
