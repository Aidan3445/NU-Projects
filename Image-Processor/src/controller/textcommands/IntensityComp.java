...
/**
 * Class represents the intensity component greyscale command.
 */
public class IntensityComp extends NameDestCommand {
  /**
   ...
   */
  public IntensityComp(String name, String dest) {
    super(name, dest);
  }
  ...
  public void execute(ImageProcessingModel m, ImageProcessingTextView v)
    ...
    m.intensityComponent(this.name, this.dest);
    v.renderMessage(
            String.format("%s was saved as a intensity component greyscale image called %s",
                    this.name, this.dest));
  }
}
